...
namespace RabbitMQ
{
    class DirectExchange : IRabbitMQProcess
    {
        ...
        public OperationResult Login(SystemDefinitions Queue)
        {
            ...
            try
            {
                ...
                _channel.ExchangeDeclare(exchange: _queue.Exchange, type: ExchangeType.Direct);
        ...
        public OperationResult Send(string Message)
        {
            ...
            try
            {
                ...
                //properties.Headers.Add("payment", "check");
                //properties.Headers.Add("payment", "credit");
