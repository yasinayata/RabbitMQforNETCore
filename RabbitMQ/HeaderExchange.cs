...
namespace RabbitMQ
{
    class HeaderExchange : IRabbitMQProcess
    {
        ...
        public OperationResult Login(SystemDefinitions Queue)
        {
            ...
            try
            {
                ...
                //Dictionary<string, object> ttl = new Dictionary<string, object> { { "x-message-ttl", 5000 } };                                
                //_channel.ExchangeDeclare(exchange: _queue.Exchange, type: ExchangeType.Headers, arguments: ttl);
                
                _channel.ExchangeDeclare(exchange: _queue.Exchange, type: ExchangeType.Headers);
                ...
                //_channel.QueueBind(queue: _queue.Queue, exchange: _queue.Exchange, routingKey: _queue.RoutingKey, header);
