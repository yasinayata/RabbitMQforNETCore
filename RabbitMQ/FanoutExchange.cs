...
namespace RabbitMQ
{
    class FanoutExchange : IRabbitMQProcess
    {
        ...
        public OperationResult Login(SystemDefinitions Queue)
        {
            ...
            try
            {
                ...
                //_channel.ExchangeDeclare(exchange: _queue.Exchange, type: ExchangeType.Fanout, arguments: ttl);

                _channel.ExchangeDeclare(exchange: _queue.Exchange, type: ExchangeType.Fanout);
